...
! function (t) {
	...
	n(121), n(122), n(22), n(125), n(315), n(316), n(317), n(318), n(319), n(324), t.exports = n(325)
}, function (t, e, n) {
	"use strict";
	var r = n(0)(n(13));
	! function () {
...
Webflow.require('ix2').init({
	"events": {
		...
		"e-3": {
			...
			"target": {
				"selector": ".news-item",
				"originalId": "5fd572b0b1b5fd68d9bc7716|d2f4a941-f6b1-bf79-2520-eafe36697777",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".news-item",
		...
		"e-33": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": "._360-accordion-wrapper-control",
				"originalId": "605a3a23eba081618dff0384|45a701ce-a541-0c18-62aa-1df703f49806",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": "._360-accordion-wrapper-control",
	...
	"actionLists": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"selector": ".hero-heading-bottom._1",
							"selectorGuids": ["88cfb13d-f794-0bcd-f45f-0166fbe2fc44", "68ffbfc2-0668-66c8-f903-9214e4708039"]
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"selector": ".hero-heading-bottom._2",
							"selectorGuids": ["88cfb13d-f794-0bcd-f45f-0166fbe2fc44", "91cba156-a31e-5bc6-7e88-7eec8c90ee6b"]
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"selector": ".hero-heading-bottom._3",
							"selectorGuids": ["88cfb13d-f794-0bcd-f45f-0166fbe2fc44", "c69e48b7-3349-1143-ab5e-d54a18b908cd"]
						},
						"value": 0,
						"unit": ""
					}
		...
		"a-2": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selector": ".news-image",
							"selectorGuids": ["43fda09f-6b38-e132-bf66-8c213ca20be3"]
						},
						"xValue": 1.2,
						"yValue": 1.2,
						"locked": true
			...
			"createdOn": 1607923127528
		},
		"a-3": {
			"id": "a-3",
			"title": "Hover News: OFF",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-3-n",
					"actionTypeId": "TRANSFORM_SCALE",
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selector": "._360-accordion-wrapper-content-block",
							"selectorGuids": ["52b174f1-5b7d-f629-ed48-9c0e8b40168e"]
						},
						"heightValue": 0,
						"widthUnit": "PX",
						"heightUnit": "PX",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".accordionplus",
							"selectorGuids": ["52b174f1-5b7d-f629-ed48-9c0e8b40168b"]
						},
						"value": 0,
						"unit": ""
					}
